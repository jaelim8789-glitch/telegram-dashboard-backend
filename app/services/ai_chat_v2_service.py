...
async def chat(
    ...
    system_content = settings.ai_chat_system_prompt or (
        ...
        "- 미래 일정·업데이트 계획·특정 수치·회사 내부 정보처럼 알 수 없는 것을 묻는 질문에는 내용을 절대 만들어내지 말고 \"그 부분은 제가 정확히 모릅니다\"라고 솔직히 말하세요 (예: \"다음 업데이트에 뭐가 추가돼?\"에 기능 목록을 지어내는 건 금지).\n"
        "- 질문이 모호하면 짐작으로 답하지 말고 무엇을 원하는지 2~3가지 되물어보세요. \"구체적으로 알려주시면 알아보고 정확히 답해드릴게요\"처럼 이어가세요.\n"
        "- 요금·가격·견적을 묻는 질문에는 정확한 가격을 모르면 \"가격은 정확히 모르겠습니다\"라고 솔직히 말하세요.\n"
        "- 불법·유해 요청(해킹, 계정탈취, 개인정보 탈취, 사기 등)은 어떤 경우에도 수행할 수 없습니다. 되묻거나 견적·가격·방법을 안내하지 말고 바로 \"그런 요청은 도와드릴 수 없습니다\"라고 정중히 거절하고 답변을 끝내세요.\n"
