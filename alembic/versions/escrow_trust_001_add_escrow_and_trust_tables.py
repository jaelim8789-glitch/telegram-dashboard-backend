...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("tenant_id", sa.String(36), sa.index=True),
        sa.Column("account_id", sa.String(36), sa.index=True),
        sa.Column("chat_id", sa.String(36), sa.index=True),
        sa.Column("buyer_id", sa.String(36), sa.index=True),
        sa.Column("seller_id", sa.String(36), sa.index=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.String(36), primary_key=True),
        sa.Column("tenant_id", sa.String(36), sa.index=True),
        sa.Column("telegram_user_id", sa.String(36), sa.index=True),
    ...
    op.create_table(
        ...
        sa.Column("escrow_id", sa.String(36), sa.ForeignKey("escrows.id", ondelete="CASCADE"), index=True),
        sa.Column("tenant_id", sa.String(36), sa.index=True),
        sa.Column("reviewer_id", sa.String(36), sa.index=True),
        sa.Column("target_id", sa.String(36), sa.index=True),
