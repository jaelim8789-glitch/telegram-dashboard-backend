...
async def approve_draft(
    ...
    try:
        ...
        logger.info(
            ...
            draft_id, identity.user_id, new_status,
        )
...
async def reject_draft(
    ...
    try:
        ...
        logger.info("[draft] rejected: id=%s user=%s", draft_id, identity.user_id)
...
async def batch_approve_drafts(
    ...
    try:
        ...
        logger.info(
            ...
            identity.user_id, len(draft_ids), approved, broadcast_count,
        )
...
async def batch_reject_drafts(
    ...
    try:
        ...
        logger.info("[draft] batch reject: user=%s requested=%d rejected=%d", identity.user_id, len(draft_ids), rejected)
...
async def batch_delete_drafts(
    ...
    try:
        ...
        logger.info("[draft] batch delete: user=%s count=%d", identity.user_id, len(draft_ids))
